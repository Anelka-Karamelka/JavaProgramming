...
public class RemoveElements1 {
    ...
    public static void main(String[] args) {
        ...
        numbers = removeElements(numbers,1);//new array 100 300 400 500 600
        numbers = removeElements(numbers,1);//new array 100 400 500 600
    ...
    // removes index from the array and returns new array
    public static int [] removeElements(int[] array, int index){
        ...
        for (int i=0; i< array.length;i++) {
            if(i==index){//if the elemnet of array is matching with the element at given index
                continue;//skip
            }
            result[j++]=array[i];
        }
