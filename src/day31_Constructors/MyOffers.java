...
public class MyOffers {
    public static void main(String[] args) {
        ...
        offer5.setInfo("WA", "Bank of Amercia", "QA", 130000, true, true, false, true);
        ...
        fullTimeOffers.removeIf(p-> !p.isFullTime); // removers if offer is NOT full time
