...
public class WarmupTasks {
    public static void main(String[] args) {
        ...
        ArrayList<Character> letters  = new ArrayList<>(chars); // added all characters
        System.out.println(letters);

        letters.removeIf(p-> !Character.isLetter(p)  ); // remove the characters that are not letters
        System.out.println("letters = " + letters);

        ArrayList<Character> digits  = new ArrayList<>(chars); // added all digits
        digits.removeIf(p-> !Character.isDigit(p) );   // remove the characters that are digits
        System.out.println("digits = " + digits);

        ArrayList<Character> specialChars  = new ArrayList<>(chars); // added all special characters
