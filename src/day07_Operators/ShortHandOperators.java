...
public class ShortHandOperators {
    ...
    public static void main(String[] args) {
        ...
        // deposit 300$;
        availableBalance +=300;              // availableBalance = 1300.5 + 300

        System.out.println("availableBalance = " + availableBalance);  //1300.5

        System.out.println("----------------");    // availableBalance = 1300.5-300
        ...
        // withdrawing 200$, then depositig 400$

        availableBalance -=200;    // available Balance =600.5
        availableBalance +=400;     // available balance =
